    ...
    <Link href='/' passHref legacyBehavior>
      <div className='flex flex-nowrap items-center cursor-pointer font-extrabold'>
        ...
        <div id='logo-text' className='group rounded-2xl flex-none relative'>
          {/* <div className='logo group-hover:opacity-0 opacity-100 visible group-hover:invisible my-auto rounded dark:border-white duration-200 text-xl font-bold text-gray-800'> */}
          <div className='logo group-hover:opacity-0 opacity-100 visible group-hover:invisible my-auto rounded dark:border-white duration-200 text-xl font-bold text-gray-800'>
            {siteConfig('TITLE')}
          </div>
