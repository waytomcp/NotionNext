...
const Hero = props => {
  ...
  return (
    <div
      id='hero-wrapper'
      className='recent-top-post-group w-full overflow-hidden select-none'>
      <div
        id='hero'
        style={{ zIndex: 1 }}
          ...
          <div className={`bg-gradient-to-r from-${HEO_FULL_BANNER[0]?.bgColor || ''}-50 to-indigo-50 py-12 w-full`}>
            <div className="container mx-auto px-4 text-center">
              ...
              <div className="flex justify-center space-x-6 mt-8">
                <SearchInput cRef={cRef} {...props} className="h-[60px] bg-[#fafafa] border border-[#587ae0] rounded-md" />
              </div>
            </div>
          </div>
          : null
